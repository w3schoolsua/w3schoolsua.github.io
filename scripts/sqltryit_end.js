...
//  window.editor.on("change", function () {window.editor.save();});
    ...
    idoc.write("<div style='margin:10px;font-size:14px;font-family: Verdana, sans-serif'>Натисніть <b>'Виконати SQL'</b> для виконання SQL-інструкції вище.</div>");
}
    ...
    txt = '';
    txt = txt + '<table style="width: 100%" class="notranslate">';
    txt = txt + '<tr><th style="text-align:left;">Названия таблиц</th><th style="text-align:right;">Записи</th></tr>';
    txt = txt + '<tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Customers\')">Клієнти</td>';
    txt = txt + '<td style="text-align:right;">91</td>';
    txt = txt + '</tr><tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Categories\')">Категорії</td>';
    txt = txt + '<td style="text-align:right;">8</td>';
    txt = txt + '</tr><tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Employees\')">Співробітники </td>';
    txt = txt + '<td style="text-align:right;">10</td></tr>';
    txt = txt + '<tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'OrderDetails\')">Деталі замовлення</td>';
    txt = txt + '<td style="text-align:right;">518</td></tr>';
    txt = txt + '<tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Orders\')">Замовлення</td>';
    txt = txt + '<td style="text-align:right;">196</td></tr>';
    txt = txt + '<tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Products\')">Продукти</td>';
    txt = txt + '<td style="text-align:right;">77</td></tr>';
    txt = txt + '<tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Shippers\')">Вантажовідправники</td>';
    txt = txt + '<td style="text-align:right;">3</td></tr>';
    txt = txt + '<tr><td style="text-align:left;cursor:pointer;text-decoration:underline;" onclick="w3schoolsNoWebSQLSelectStar(\'Suppliers\')">Постачальники</td>';
