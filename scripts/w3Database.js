                ...
                tx.executeSql(sql,[],function (tx, results)
                    {
                        ...
                        if (len > 0) {
                            txt = "";
                            txt = txt + "<div style='padding:10px;'><div style='margin-bottom:10px;'>Количество записей: " + len + "</div>";
                ...
                tx.executeSql('CREATE TABLE Customers (CustomerID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,CustomerName NVARCHAR(255),ContactName NVARCHAR(255),Address NVARCHAR(255),City NVARCHAR(255),PostalCode NVARCHAR(255),Country NVARCHAR(255))',[], function(tx)
                    {
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Ana Trujillo Emparedados y helados","Ana Trujillo","Avda. de la Constituciуn 2222","Mйxico D.F.","05021","Mexico")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Antonio Moreno Taquerнa","Antonio Moreno","Mataderos 2312","Mйxico D.F.","05023","Mexico")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Berglunds snabbkцp","Christina Berglund","Berguvsvдgen 8","Luleе","S-958 22","Sweden")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Blondel pиre et fils","Frйdйrique Citeaux","24, place Klйber","Strasbourg","67000","France")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Bуlido Comidas preparadas","Martнn Sommer","C/ Araquil, 67","Madrid","28023","Spain")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Centro comercial Moctezuma","Francisco Chang","Sierras de Granada 9993","Mйxico D.F.","05022","Mexico")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Comйrcio Mineiro","Pedro Afonso","Av. dos Lusнadas, 23","Sгo Paulo","05432-043","Brazil")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Familia Arquibaldo","Aria Cruz","Rua Orуs, 92","Sгo Paulo","05442-030","Brazil")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Folies gourmandes","Martine Rancй","184, chaussйe de Tournai","Lille","59000","France")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Folk och fд HB","Maria Larsson","Еkergatan 24","Brдcke","S-844 67","Sweden")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Frankenversand","Peter Franken","Berliner Platz 43","Mьnchen","80805","Germany")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Galerнa del gastrуnomo","Eduardo Saavedra","Rambla de Cataluсa, 23","Barcelona","08022","Spain")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Godos Cocina Tнpica","Josй Pedro Freyre","C/ Romero, 33","Sevilla","41101","Spain")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Gourmet Lanchonetes","Andrй Fonseca","Av. Brasil, 442","Campinas","04876-786","Brazil")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("GROSELLA-Restaurante","Manuel Pereira","5Є Ave. Los Palos Grandes","Caracas","1081","Venezuela")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Hanari Carnes","Mario Pontes","Rua do Paзo, 67","Rio de Janeiro","05454-876","Brazil")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("HILARIУN-Abastos","Carlos Hernбndez","Carrera 22 con Ave. Carlos Soublette #8-35","San Cristуbal","5022","Venezuela")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Kцniglich Essen","Philip Cramer","Maubelstr. 90","Brandenburg","14776","Germany")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("LILA-Supermercado","Carlos Gonzбlez","Carrera 52 con Ave. Bolнvar #65-98 Llano Largo","Barquisimeto","3508","Venezuela")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Mиre Paillarde","Jean Fresniиre","43 rue St. Laurent","Montrйal","H1J 1C3","Canada")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Ocйano Atlбntico Ltda.","Yvonne Moncada","Ing. Gustavo Moncada 8585 Piso 20-A","Buenos Aires","1010","Argentina")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Ottilies Kдseladen","Henriette Pfalzheim","Mehrheimerstr. 369","Kцln","50739","Germany")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Paris spйcialitйs","Marie Bertrand","265, boulevard Charonne","Paris","75012","France")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Pericles Comidas clбsicas","Guillermo Fernбndez","Calle Dr. Jorge Cash 321","Mйxico D.F.","05033","Mexico")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Princesa Isabel Vinhoss","Isabel de Castro","Estrada da saъde n. 58","Lisboa","1756","Portugal")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Que Delнcia","Bernardo Batista","Rua da Panificadora, 12","Rio de Janeiro","02389-673","Brazil")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Queen Cozinha","Lъcia Carvalho","Alameda dos Canаrios, 891","Sгo Paulo","05487-020","Brazil")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("QUICK-Stop","Horst Kloss","TaucherstraЯe 10","Cunewalde","01307","Germany")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Rancho grande","Sergio Gutiйrrez","Av. del Libertador 900","Buenos Aires","1010","Argentina")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Richter Supermarkt","Michael Holz","Grenzacherweg 237","Genиve","1203","Switzerland")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Romero y tomillo","Alejandra Camino","Gran Vнa, 1","Madrid","28001","Spain")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Santй Gourmet","Jonas Bergulfsen","Erling Skakkes gate 78","Stavern","4110","Norway")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Simons bistro","Jytte Petersen","Vinbжltet 34","Kшbenhavn","1734","Denmark")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Spйcialitйs du monde","Dominique Perrier","25, rue Lauriston","Paris","75016","France")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Suprкmes dйlices","Pascale Cartrain","Boulevard Tirou, 255","Charleroi","B-6000","Belgium")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Toms Spezialitдten","Karin Josephs","Luisenstr. 48","Mьnster","44087","Germany")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Tortuga Restaurante","Miguel Angel Paolino","Avda. Azteca 123","Mйxico D.F.","05033","Mexico")');
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Tradiзгo Hipermercados","Anabela Domingues","Av. Inкs de Castro, 414","Sгo Paulo","05634-030","Brazil")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Vaffeljernet","Palle Ibsen","Smagslшget 45","Еrhus","8200","Denmark")');
                        ...
                        tx.executeSql('INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country) VALUES ("Die Wandernde Kuh","Rita Mьller","Adenauerallee 900","Stuttgart","70563","Germany")');
                ...
                tx.executeSql('CREATE TABLE Products (ProductID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,ProductName NVARCHAR(255),SupplierID INT,CategoryID INT,Unit NVARCHAR(255),Price MONEY)',[], function(tx)
                    {
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (22,"Gustaf\'s Knдckebrцd",9,5,"24 - 500 g pkgs.",21)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (23,"Tunnbrцd",9,5,"12 - 250 g pkgs.",9)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (24,"Guaranб Fantбstica",10,1,"12 - 355 ml cans",4.5)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (25,"NuNuCa NuЯ-Nougat-Creme",11,3,"20 - 450 g glasses",14)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (26,"Gumbдr Gummibдrchen",11,3,"100 - 250 g bags",31.23)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (28,"Rцssle Sauerkraut",12,7,"25 - 825 g cans",45.6)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (29,"Thьringer Rostbratwurst",12,6,"50 bags x 30 sausgs.",123.79)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (38,"Cфte de Blaye",18,1,"12 - 75 cl bottles",263.5)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (45,"Rшgede sild",21,8,"1k pkg.",9.5)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (54,"Tourtiиre",25,6,"16 pies",7.45)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (55,"Pвtй chinois",25,6,"24 boxes x 2 pies",24)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (61,"Sirop d\'йrable",29,2,"24 - 500 ml bottles",28.5)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (64,"Wimmers gute Semmelknцdel",12,5,"20 bags x 4 pieces",33.25)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (71,"Flшtemysost",15,4,"10 - 500 g pkgs.",21.5)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (73,"Rцd Kaviar",17,8,"24 - 150 g jars",15)');
                        ...
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (75,"Rhцnbrдu Klosterbier",12,1,"24 - 0.5 l bottles",7.75)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (76,"Lakkalikццri",23,1,"500 ml ",18)');
                        tx.executeSql('INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price) VALUES (77,"Original Frankfurter grьne SoЯe",12,2,"12 boxes",13)');
                    }
                );
            }
            ,function (err) {
                ...
                tx.executeSql('CREATE TABLE Suppliers (SupplierID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,SupplierName NVARCHAR(255),ContactName NVARCHAR(255),Address NVARCHAR(255),City NVARCHAR(255),PostalCode NVARCHAR(255),Country NVARCHAR(255),Phone NVARCHAR(255))',[], function(tx)
                    {
                        ...
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (9,"PB Knдckebrцd AB","Lars Peterson","Kaloadagatan 13","Gцteborg","S-345 67","Sweden ","031-987 65 43")'); 
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (10,"Refrescos Americanas LTDA","Carlos Diaz","Av. das Americanas 12.890","Sгo Paulo","5442","Brazil","(11) 555 4640")'); 
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (11,"Heli SьЯwaren GmbH &amp; Co. KG","Petra Winkler","TiergartenstraЯe 5","Berlin","10785","Germany","(010) 9984510")'); 
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (12,"Plutzer LebensmittelgroЯmдrkte AG","Martin Bein","Bogenallee 51","Frankfurt","60439","Germany","(069) 992755")'); 
                        ...
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (17,"Svensk Sjцfцda AB","Michael Bjцrn","Brovallavдgen 231","Stockholm","S-123 45","Sweden","08-123 45 67")'); 
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (18,"Aux joyeux ecclйsiastiques","Guylиne Nodier","203, Rue des Francs-Bourgeois","Paris","75004","France","(1) 03.83.00.68")'); 
                        ...
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (25,"Ma Maison","Jean-Guy Lauzon","2960 Rue St. Laurent","Montrйal","H1J 1C3","Canada","(514) 555-9022")'); 
                        ...
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (28,"Gai pвturage","Eliane Noz","Bat. B 3, rue des Alpes","Annecy","74000","France","38.76.98.06")'); 
                        tx.executeSql('INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone) VALUES (29,"Forкts d\'йrables","Chantal Goulet","148 rue Chasseur","Ste-Hyacinthe","J2S 7S8","Canada","(514) 555-2955")',[], function(tx)
                            {
