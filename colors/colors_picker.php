...
<title>HTML Палітра кольорів. <?php include '../include/title.php'; ?></title>
<meta name='description' content='HTML Палітра кольорів. Кольорова палітра. Як обрати кольори для веб-сайта? <?php include '../include/description.php'; ?>'>
    <style>
        #selectedcolor {
...
<article>
    <h1>HTML <span class="color_h1">Палітра кольорів</span></h1>
    ...
    <div class="w3-row">
        ...
        <div class="w3-col colorthird1" style="text-align:center;">
            ...
            <div style="margin:auto;width:236px;">
                ...
                <div id="wronginputDIV">Неправильне введення</div>
                <br>
                <div id="html5DIV">
                    <h3>Або використовуйте HTML5:</h3>
        ...
        <div class="w3-col colorthird2" style="text-align:center;">
            ...
            <div id="selectedcolor" class="w3-large">
                <br><br>
                <span class="w3-text-black">Чорний текст</span><br><br>
                <span class="w3-text-black" style="text-shadow:1px 1px 0 #444">Тінь</span><br><br>
                <span class="w3-text-white">Білий текст</span><br><br>
                <span class="w3-text-white" style="text-shadow:1px 1px 0 #444">Тінь</span>
            </div>
